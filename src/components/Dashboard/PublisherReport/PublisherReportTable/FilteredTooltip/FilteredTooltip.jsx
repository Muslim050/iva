...
function FilteredTooltip({
  ...
  startDate,
  endDate,
  closeH,handleSearch,selectedOption,
                             handleEndDateChange,
          ...
          >
            ...
            <div style={{width: '300px'}}>
              ...
              >
                Выбрать канал
                <select
                    value={selectedOption} // Используйте ID, а не имя, для value
              ...
              <div style={{display: "flex", marginTop: "20px", gap: "10px"}}>
                  {(selectedAdvertiser || startDate || endDate || selectedFormat) && (
                      <div style={{width: "100%"}}>
                          <ButtonTable onClick={handleClear} Customstyle={{width: "100%", justifyContent: "center"}}>
                  ...
                  <div style={{width: "100%"}}>
                      <ButtonTable onClick={handleSearch} Customstyle={{width: "100%", justifyContent: "center"}}>
